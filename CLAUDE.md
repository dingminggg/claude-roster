...
- **主视图是一张办公室平面图**(不再是竖排卡片列表):可滚动、Ctrl+滚轮缩放的画布,上面是**部门地毯**(按 `Member.dept` 分,没填的进「未分配」),地毯上摆着**工位**。工位 180×112,俯视画法:L 形隔断 + 大桌板(显示器背面 / 键盘 / 鼠标 / 刻在桌面的成员名)+ 办公椅(靠背用成员配色)+ 员工 emoji + 绿植。
